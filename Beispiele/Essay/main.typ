...
Dieser Argumentationsgang ist jedoch aus zwei Punkten problematisch: Erstens sind die Stufen nicht so klar, wie Descartes es beschreibt, voneinander abtrennbar und zweitens ist die Methode eines radikalen Zweifels beschränkt auf die Vorstellungskraft des Zweiflenden. Descartes hat ein grundlegendes Problem: Er ist nicht so genau, wie er vorgibt zu sein.
